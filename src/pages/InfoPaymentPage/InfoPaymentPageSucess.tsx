...
export const InfoPaymentPageSucess = () => {
  ...
  const products_info = queryParams.get("products_info");


  console.log(userId,orderId,email,phone);
...
}, [dispatch, orderRes.orderId, payApiPassword, payApiUsername, user.id, user.email, user.phone, user.address, user.city, orderStatus.OrderStatus, user.name, user.surname, orderId, sum, product_quantity, products_info]);
